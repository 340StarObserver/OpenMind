...
### 05. 个人项目数据的封装（移动端） ###
            ...
            包含属性 ： 形式上形如 doc/design/data.md 中的 项目数据project_info  
...
### 06. 个人活跃数据的封装（移动端） ###
            ...
            包含属性 ： 形式上如 doc/design/data.md 中的 个人活跃数据active_info  
...
### 10. 新增一个项目（网页端） ###
            ...
            所需数据 ： 项目名称，标签们，可选链接，项目简介，可附带多个文件，令牌token(用于认证)  
...
### 12. 浏览所有项目的概要信息 ###
            ...
            对于每个项目，获取 :  
                ...
                项目id（不展示），项目名称，发起人用户名，发起人姓名，发起时间，标签们，项目简介  
...
### 13. 浏览自己的所有项目的概要信息 ###
            ...
            若是移动端，则不需要登陆，且从本地数据库中拿东西，不向服务端发请求  
            
            若是网页端，则需要登陆，且向服务端发请求来获取自己所有项目的概要信息  
...
### 15. 同步自己的数据（移动端） ###
            ...
            客户端接收到响应后 :  
                ...
                从响应体中获取个人项目数据 + 活跃数据，并统统持久化到本地数据库  


### 16. 浏览具体的一个项目中的某个分享文档的信息 ###
...
### 19. 查看与我相关的消息 ###
            ...
            客户端对于每条记录，显示谁(他的用户名，姓名)在何时针对哪个项目(项目名称)发表了什么评论  
